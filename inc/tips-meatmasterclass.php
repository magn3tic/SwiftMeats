<?php
    // WP_Query arguments
    $args = array(
        'post__in' => get_sub_field('recipes'),
        'post_type'              => 'tips',
        'posts_per_page' => -1,
        'orderby' => 'menu_order',
        'order' => 'ASC',
    ...
    ?>
    <!-- ===== RECIPE TYPE ===== -->
    <div class="tip-item mmc-tip-item ti-recipe <?= the_field('cooking_style');?> <?= the_field('ingredient_item');?>">
        <div class="tip-accent-top"></div>
        <div class="tip-accent-top-left"></div>
        <div class="tip-accent-top-right"></div>
        <div class="tip-accent-left"></div>
        <div class="tip-accent-right"></div>
        <div class="tip-accent-bottom"></div>
        <div class="tip-accent-bottom-left"></div>
        <div class="tip-accent-bottom-right"></div>

        <?php $img = get_field('image') ? get_field('image') : get_template_directory_uri() .'/assets/img/tips/recipe-ex.jpg'; ?>
        <div class="inner" data-toggle="modal" data-target="#tip-<?= $id;?>">
            <div class="inner-photo" style="background: url('<?=$img;?>') no-repeat center / cover;"></div>
        </div>
        <!-- /.inner -->
        <div class="tip-headline" data-toggle="modal" data-target="#tip-<?= $id;?>">
            <?php if(get_field('headline')) { ?>
                <h3><?= the_field('headline');?></h3>
            <?php } else { ?>
                <h3><?php the_title();?></h3>
            <?php } ?>
            <?php if(get_field('short_description')): ?>
            <div class="tip-headline-text"><?php print get_field('short_description'); ?></div>
            <?php endif; ?>
            <span class="btn gold-btn">View Recipe</span>
        </div>
        <!-- /.tip-headline -->
    </div>
    ...
    <!-- ===== GRAPHIC TYPE ===== -->
    <div class="tip-item mmc-tip-item ti-graphic <?= the_field('ingredient_item');?>">
        <div class="inner">
    ...
    <!-- ===== IMAGE TYPE ===== -->
    <div class="tip-item mmc-tip-item ti-image <?= the_field('cooking_style');?> <?= the_field('ingredient_item');?>">
        <div class="inner">
            <div class="tip-overlay" data-toggle="modal" data-target="#tip-<?= $id; ?>"></div>
            <img src="<?= the_field('image');?>" alt="<?php the_title();?>">
            <!-- /.tip-overlay -->
