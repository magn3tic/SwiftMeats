...
<section id="filter-wrap">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2>Swift Veal Products</h2>
                <p>Swift Veal stands for premium quality, tenderness and exquisite taste. </p>
                <p>Veal also presents many health benefits being a lean meat, low in sodium and low in cholesterol. Veal is also rich in vitamins, such as vitamin B1, vitamin D, protein and iron.</p>
            </div>
            <!-- /.col-12 -->
        </div>
        <!-- /.row -->
...
<!-- /#products-wrap -->
<?php if( have_rows('veal_page_next_level') ): ?>
<?php $i=0;?>
<section id="product-next-level">
    <div class="container">
        ...
        <!-- /.row -->
        <div class="row">
            <?php while( have_rows('veal_page_next_level') ): the_row(); ?>
                <?php  
                ...
                ?>
                <div class="col-xl-4 col-lg-4 col-md-4 col-12 col-xs-12 product-other-item" data-toggle="modal" data-target="#tip-<?= $i;?>">
